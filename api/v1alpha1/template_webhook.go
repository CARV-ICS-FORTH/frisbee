...
// +kubebuilder:webhook:path=/mutate-frisbee.io-v1alpha1-template,mutating=true,failurePolicy=fail,sideEffects=None,groups=frisbee.io,resources=templates,verbs=create;update,versions=v1alpha1,name=mtemplate.kb.io,admissionReviewVersions={v1}
...
// +kubebuilder:webhook:path=/validate-frisbee.io-v1alpha1-template,mutating=false,failurePolicy=fail,sideEffects=None,groups=frisbee.io,resources=templates,verbs=create;update,versions=v1alpha1,name=vtemplate.kb.io,admissionReviewVersions={v1}
