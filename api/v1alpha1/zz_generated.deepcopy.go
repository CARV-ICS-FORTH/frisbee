...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScenarioOptions) DeepCopyInto(out *ScenarioOptions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScenarioOptions.
func (in *ScenarioOptions) DeepCopy() *ScenarioOptions {
	if in == nil {
		return nil
	}
	out := new(ScenarioOptions)
	in.DeepCopyInto(out)
	return out
}
