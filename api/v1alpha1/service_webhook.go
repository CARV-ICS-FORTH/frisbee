...
// +kubebuilder:webhook:path=/mutate-frisbee.io-v1alpha1-service,mutating=true,failurePolicy=fail,sideEffects=None,groups=frisbee.io,resources=services,verbs=create;update,versions=v1alpha1,name=mservice.kb.io,admissionReviewVersions={v1,v1beta1}
...
// +kubebuilder:webhook:path=/validate-frisbee.io-v1alpha1-service,mutating=false,failurePolicy=fail,sideEffects=None,groups=frisbee.io,resources=services,verbs=create;update,versions=v1alpha1,name=vservice.kb.io,admissionReviewVersions={v1,v1beta1}
