...
/*
// Param represents an parameter present in a Frisbee template. By default, Frisbee expects
// a higher level entity, such as the Workflow, to define these parameters. Otherwise, FromTemplate can be used
// to auto-produce them.
type Param struct {
	// Name of the environment variable. Must be a C_IDENTIFIER.
	Name string `json:"name"`

	// Auto  means that the parameter will be autogenerated based on the given template.
