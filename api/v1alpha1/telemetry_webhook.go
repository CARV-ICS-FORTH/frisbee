...
// +kubebuilder:webhook:path=/mutate-telemetry,mutating=true,failurePolicy=fail,sideEffects=None,groups=frisbee.io,resources=telemetries,verbs=create;update,versions=v1alpha1,name=mtelemetry.kb.io,admissionReviewVersions={v1,v1alpha1}
...
// +kubebuilder:webhook:path=/validate-telemetry,mutating=false,failurePolicy=fail,sideEffects=None,groups=frisbee.io,resources=telemetries,verbs=create;update,versions=v1alpha1,name=vtelemetry.kb.io,admissionReviewVersions={v1,v1alpha1}
