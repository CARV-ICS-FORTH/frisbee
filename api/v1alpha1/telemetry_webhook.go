...
// +kubebuilder:webhook:path=/mutate-frisbee.io-v1alpha1-telemetry,mutating=true,failurePolicy=fail,sideEffects=None,groups=frisbee.io,resources=telemetries,verbs=create;update,versions=v1alpha1,name=mtelemetry.kb.io,admissionReviewVersions={v1}
...
// +kubebuilder:webhook:path=/validate-frisbee.io-v1alpha1-telemetry,mutating=false,failurePolicy=fail,sideEffects=None,groups=frisbee.io,resources=telemetries,verbs=create;update,versions=v1alpha1,name=vtelemetry.kb.io,admissionReviewVersions={v1}
