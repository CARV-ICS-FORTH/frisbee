...
func NewController(mgr ctrl.Manager, logger logr.Logger) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&v1alpha1.CollocatedGroup{}).
		Named("collocatedgroups").
		Complete(&Reconciler{
			Client: mgr.GetClient(),
			Logger: logger.WithName("collocatedgroups"),
		})
}
...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	case v1alpha1.PhasePending:
		...
		err := lifecycle.New(
			lifecycle.WatchExternal(&v1.Pod{}, lifecycle.Containers(), group.Status.ExpectedServices.GetNames()...),
	...
	case v1alpha1.PhaseSuccess: // Passthrough
		...
		logrus.Warn("GROUP ", group.GetName(), " was completed")
...
func (r *Reconciler) Finalizer() string {
	return "collocatedgroups.frisbee.io/finalizer"
}
