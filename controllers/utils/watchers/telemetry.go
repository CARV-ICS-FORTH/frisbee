...
func WatchTelemetry(r utils.Reconciler, gvk schema.GroupVersionKind) builder.Predicates {
	return builder.WithPredicates(predicate.Funcs{
		CreateFunc:  watchTelemetryCreate(r, gvk),
		DeleteFunc:  watchTelemetryDelete(r, gvk),
		UpdateFunc:  watchTelemetryUpdate(r, gvk),
		GenericFunc: watchTelemetryGeneric(r, gvk),
	})
}

func watchTelemetryCreate(r utils.Reconciler, gvk schema.GroupVersionKind) CreateFunc {
...
func watchTelemetryUpdate(r utils.Reconciler, gvk schema.GroupVersionKind) UpdateFunc {
	return func(e event.UpdateEvent) bool {
		...
		// if the status is the same, there is no need to inform the Telemetry
...
func watchTelemetryDelete(r utils.Reconciler, gvk schema.GroupVersionKind) DeleteFunc {
...
func watchTelemetryGeneric(r utils.Reconciler, gvk schema.GroupVersionKind) GenericFunc {
